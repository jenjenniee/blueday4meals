package com.example.meals.Camera;
...
public class CameraMain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomWidgetTheme.setButtonTextColor(0xE6E6FA);
        bottomWidgetTheme.setWidgetRadius(30);
        toolbarTheme.setBackgroundColor(0xE6E6FA);
        defaultWidgetTheme.setWidgetColor(0xE6E6FA);
